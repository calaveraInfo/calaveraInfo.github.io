...
vlastně úplně jiný, než účel zpracování streamu asynchronních událostí v podání Rx][stream vs rx]. Tady už ale přirovnání schází a je to ten okamžik, kdy veškeré snahy o vysvětlení připomínají nepříčetné blábolení.
...
[stream vs rx]: http://stackoverflow.com/questions/30216979/difference-between-java-8-streams-and-rxjava-observables
